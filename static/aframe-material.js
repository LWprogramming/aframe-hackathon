...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  if (!AFRAME.ASSETS_PATH) {
	    AFRAME.ASSETS_PATH = "/static/assets"; // hardcoded workaround

	    // AFRAME.ASSETS_PATH = "{{ url_for('static', filename='assets/images/BackspaceIcon.png') }}".split("/images/BackspaceIcon.png")[0]; // just want the prefix, e.g. /static/assets
	  }
